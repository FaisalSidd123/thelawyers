      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-brand-paper/10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs text-brand-paper/70 leading-relaxed mt-2">
          ...
          <div>
            <h4 className="font-serif text-sm font-semibold text-brand-paper uppercase tracking-wider mb-4 border-b border-brand-burgundy/40 pb-2">
              Quick Links
            </h4>
          ...
          <div>
            <h4 className="font-serif text-sm font-semibold text-brand-paper uppercase tracking-wider mb-4 border-b border-brand-burgundy/40 pb-2 flex items-center gap-2">
              <Shield className="w-4 h-4 text-brand-burgundy" />
              <span>Legal Disclaimer</span>
            </h4>
            <p className="text-xs text-brand-paper/65 leading-relaxed bg-brand-paper/5 p-3 rounded-sm border border-brand-paper/10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-xs">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-brand-burgundy shrink-0 mt-0.5" />
                <span className="text-brand-paper/80">Corporate & Litigation Offices in Islamabad & Lahore, Pakistan</span>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-brand-burgundy shrink-0" />
        ...
        {/* Copyright */}
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-brand-paper/50 gap-4">
          <div>
