        ...
        <section className="py-6 md:py-16 px-4 md:px-12 bg-brand-paper">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-brand-navy text-brand-paper p-6 md:p-8 rounded-md mb-8 md:mb-12 text-center">
              <h4 className="font-serif text-lg md:text-xl mb-3 md:mb-4">Scaling Your IT Firm, SaaS Product, or BPO Operations?</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 mb-6 md:mb-12">
              <div>
                <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">What We Do For Your Firm</h3>
                <ul className="space-y-2.5 text-xs md:text-sm text-brand-navy/80">
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Profile evaluation and eligibility documentation.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Submission of formal P@SHA membership applications.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Coordination for corporate verification and endorsement.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Facilitating annual renewals and access to P@SHA industry survey reports.</span></li>
                </ul>
              </div>

              <div>
                <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">Eligibility Criteria</h3>
                <ul className="space-y-2.5 text-xs md:text-sm text-brand-navy/80">
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>Must be a registered business entity in Pakistan (SECP Company or Partnership/Proprietorship).</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>Must be actively engaged in software development, IT services, BPO, or digital tech operations.</span></li>
                </ul>
              </div>
            </div>

            <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">Target Business Categories</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  ...
                  <span>Software Development Houses</span>
                </h4>
              ...
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-brand-burgundy mt-0.5 shrink-0" />
                  <span>Tech Startups & Incubators</span>
                </h4>
                <p className="text-xs md:text-sm text-brand-navy/70 leading-relaxed">
              ...
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-brand-burgundy mt-0.5 shrink-0" />
                  <span>Digital & IT Consultancies</span>
                </h4>
                <p className="text-xs md:text-sm text-brand-navy/70 leading-relaxed">
