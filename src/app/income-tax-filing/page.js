      ...
      <div className="min-h-screen bg-brand-paper font-sans text-brand-navy selection:bg-brand-burgundy selection:text-brand-paper">
        ...
        <section className="py-6 md:py-16 px-4 md:px-12 bg-brand-paper">
          <div className="max-w-4xl mx-auto">
            ...
            <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">Specialized Filing Categories</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  ...
                  <span>Salaried Individual Returns</span>
                </h4>
              ...
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-brand-burgundy mt-0.5 shrink-0" />
                  <span>Freelancer & Remote Worker Returns</span>
                </h4>
                <p className="text-xs md:text-sm text-brand-navy/70 leading-relaxed">
              ...
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-brand-burgundy mt-0.5 shrink-0" />
                  <span>Business Return Filing</span>
                </h4>
                <p className="text-xs md:text-sm text-brand-navy/70 leading-relaxed">
              ...
              <div className="bg-brand-cream/40 p-5 md:p-6 rounded-md border border-brand-light-gray">
                <h4 className="font-semibold text-brand-navy mb-2 flex items-start gap-2.5">
                  <CheckCircle2 className="w-5 h-5 text-brand-burgundy mt-0.5 shrink-0" />
                  <span>Private Limited Corporate Filing</span>
                </h4>
                <p className="text-xs md:text-sm text-brand-navy/70 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 mb-6 md:mb-12">
              <div>
                <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">Our Tax Service Packages Includes</h3>
                <ul className="space-y-2.5 text-xs md:text-sm text-brand-navy/80">
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Complete assistance to become a filer and get your name on the Active Taxpayers List (ATL).</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>End-to-end preparation, calculation, and submission of your income tax return.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Specialized assistance with the FBR income tax return form for salaried persons.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Setting up your company with the FBR, securing your NTN, and managing annual corporate tax returns.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Year-round support from a dedicated tax advisor.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Precise drafting of your assets and liabilities to avoid audit notices.</span></li>
                </ul>
              </div>

              <div>
                <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-4 md:mb-6">What Sets Our Tax Service Apart</h3>
                <ul className="space-y-2.5 text-xs md:text-sm text-brand-navy/80">
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>Thorough reconciliation of wealth statements and bank transactions to prevent FBR audit notices.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>Identification of eligible tax credits (tuition fees, life insurance, charitable donations, medical allowances).</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>Full legal representation in the event of FBR tax audits, show-cause notices, or penalty appeals.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>100% Remote: No need to visit physical offices.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-brand-burgundy mt-0.5 shrink-0" /> <span>No hidden fees. Flat-rate pricing.</span></li>
                </ul>
              </div>
            </div>
            
            <div className="bg-brand-cream/40 p-6 md:p-8 rounded-md mb-8 md:mb-12">
              <h3 className="font-serif text-xl md:text-2xl text-brand-navy mb-3 md:mb-4">Documents Required</h3>
              <p className="text-xs md:text-sm text-brand-navy/70 mb-5 md:mb-6">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-xs md:text-sm text-brand-navy/80">
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Bank statements for the financial year (July 1 to June 30).</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Salary certificates or employer tax deduction certificates.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" /> <span>Details of assets acquired or sold during the tax year (property, vehicles, stocks).</span></li>
